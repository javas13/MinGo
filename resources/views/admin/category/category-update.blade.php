...
<form id="categoryUpdateForm" class="mt-4" action="{{ route('admin.category.update.store', $category->id)}}" method="post">
    ...
    <div class="mb-3">
        ...
        <input name="name_single" type="text" class="form-control @error('name_single') is-invalid @enderror" id="name_single" placeholder="Название" value="{{old('name_single', $category->name_single)}}">
    </div>
    <div class="mb-3">
