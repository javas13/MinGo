...
<form id="article_form" class="mt-4" action="{{route ('admin.places.update.store', $place->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input name="phone_formatted" class="form-control phone-mask-js" id="phone_formatted" value="{{old('phone_formatted', $place->phone_formatted)}}">
    </div>
    <div class="mb-3">
        <label for="city" class="form-label">Город*</label>
        <select id="city" name="city_id" class="form-select" aria-label="Default select example">
            @foreach($cities as $city)
            @if (old('city_id', $place->city_id) == $city->id)
    ...
    <div class="mb-3">
        ...
        <select id="district" name="district_id" class="form-select" aria-label="Default select example">
            ...
            @if (old('district_id', $place->district_id) == $district->id)
    ...
    <div class="mb-3 d-flex flex-column">
        ...
        <div class="d-flex flex-row">
            <input name="check_in_price_from" type="number" class="form-control" placeholder="Цена заезда от" value="{{old('check_in_price_from', $place->check_in_price_from)}}">
            <input name="check_in_price_to" type="number" class="form-control" placeholder="Цена заезда до" value="{{old('check_in_price_to', $place->check_in_price_to)}}">
        </div>
    </div>
    ...
    <input type="hidden" value="" name="latitude" value="{{ old('latitude', $place->latitude) }}" id="latitude">
    <input type="hidden"  value="" name="longitude" value="{{ old('latitude', $place->longitude) }}" id="longitude">
    ...
    <div class="mb-3">
        ...
        <input name="seo_name" type="text" class="form-control @error('seo_name') is-invalid @enderror" id="seoName" placeholder="Seo name" value="{{ old('seo_name', $place->seo_name) }}">
    </div>
    <div class="mb-3">
        ...
        <input name="seo_description" maxlength="300" type="text" class="form-control max-length-count-input-js @error('seo_description') is-invalid @enderror" id="seoDescript" placeholder="Seo description" value="{{ old('seo_description', $place->seo_description) }}">
    ...
    <div class="form-group">
        ...
        <input name="image_alt" type="text" class="form-control @error('image_alt') is-invalid @enderror" id="image_alt" placeholder="Название главной картинки" value="{{ old('image_alt', $place->image_alt) }}">
